export default function Offering() {
  return (
    <main className="relative z-10 bg-one-wave bg-cover bg bg-center">
        <div className="mt-20 grid-cols-2 text-center mx-auto px-24 w-screen flex justify-around lg:flex-row flex-wrap">
          ...
          <div className="relative  bg-gradient-to-b from-gray-300 to-gray-300 rounded-lg shadow-lg w-1/2 h-90 overflow-hidden md:h-96 md:w-96 ">
